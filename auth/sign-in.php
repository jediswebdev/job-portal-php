...
if (isset($_POST['submit'])) {
    ...
    // If login succeeds, loginUser() handles the redirect directly
    // If it fails, $response holds the error string to display on the form
    $response = $authService->loginUser($email, $password);
}
?>
...
<head>
    ...
    <title>Sign In - JKyber Labs</title>
        ...
        <div
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-400 mt-4 leading-relaxed">Sign in to access your account dashboard,
                        track applications, or post new opportunities.</p>
                </div>
                <div>
                    <h2 class="text-white text-lg font-medium">Fast & Secure Access</h2>
                    <p class="text-sm text-slate-400 mt-4 leading-relaxed">We keep your account safe with modern
                        authentication standards.</p>
                </div>
            </div>
            ...
            <div class="w-full py-6 px-6 max-w-lg mx-auto md:col-span-2 md:px-14">
                ...
                <div class="mb-10 flex flex-row gap-3">
                    ...
                    <h1 class="text-slate-900 text-2xl font-bold my-auto">Sign in</h1>
                </div>

                <form class="space-y-6 mb-4" method="POST" action="">
                    <?php if (isset($_GET['logged_out'])): ?>
                        <div
                            class="mb-4 p-3 bg-blue-50 border border-blue-200 text-blue-700 rounded-md text-sm text-center font-medium">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <label for="password"
                                class="text-slate-900 font-medium text-sm inline-block">Password</label>
                ...
                <div class="mt-4 text-center text-black">
                    <?php if ($response): ?>
                        <?php if (is_array($response) && isset($response['msg']) && $response['msg'] === "success"): ?>
                            <p class="text-center text-green-600 font-medium">Login successful!</p>
